...
const selectedChapterForVideo = ref<Topic2Chapter | null>(null);
...
const openVideoModal = (chapter: Topic2Chapter) => {
...
const handleVideoSubmit = () => {
    ...
    router.put(`/topic2/chapter/${selectedChapterForVideo.value.id}/video`, {
