...
const openModal = (type: 'view' | 'add' | 'edit' | 'delete', item?: Category, isNewCategory = false) => {
    ...
    switch (type) {
        ...
        case 'edit':
            ...
            if (item?.parent_id) {
                // Sub-category: find position within parent's children
                        ...
                        >
                            ...
                            <div v-if="category.children?.length">
                                <div
                                    ...
                                    @click="router.visit(`${props.lang === 'CH' ? '/video/daftar-isi' : '/video/topik'}/category/${child.id}`)"
                                >
